...
<div class="dashboard">
    ...
    <div class="sidebar">
        ...
        <div class="nav-section">
          ...
          <a href="/repuestos" class="nav-item active">
      ...
      <div class="main-content">
        <div class="header">
          <h1 class="page-title">Repuestos de máquinas de panadería</h1>
        ...
        <div class="categories-filters">
          <div class="filter-chip active">Todos los Repuestos</div>
          <div class="filter-chip">Horno</div>
          <div class="filter-chip">Amasadora</div>
          <div class="filter-chip">Panaderia</div>
        </div>

        <!-- Lista de repuestos -->
        <div class="menu-items" id="productos-container">
